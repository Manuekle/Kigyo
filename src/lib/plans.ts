...
const GROWTH = [
  ...
  'pos', 'caja', 'tiempos', 'suscripciones', 'cartera', 'notificaciones', 'reportes', 'creditos', 'donantes', 'suscriptores', 'puestos', 'calidad', 'obra', 'ph', 'contratacion', 'portal', 'marketing', 'integraciones',
  'consultoria', 'ia',
