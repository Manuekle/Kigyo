...
function CsvFileActionsMenu({
  ...
  // Kigyo: el menú de 3 puntos no se usa en la vista previa; la descarga vive
  // en la fila del documento. Se conserva la firma por si el bloque vuelve.
  return null
}
          ...
          <div className="ml-auto flex min-w-0 flex-wrap items-center justify-end gap-1">
            <div className="flex flex-none items-center gap-1">
              ...
              <Select
                ...
                onChange={(value) => setZoom(Number(value) as (typeof ZOOM_OPTIONS)[number])}
