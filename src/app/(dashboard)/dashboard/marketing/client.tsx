...
import { Plus, Send, Star, Trash2, UserCheck, XCircle } from '@/lib/icons'
import Badge from '@/components/ui/Badge'
import Select from '@/components/ui/Select'
import Stat from '@/components/ui/Stat'
import { useApp } from '@/lib/context/AppContext'
import type { StatusTone } from '@/lib/types'
import type { MarketingData, CampaignChannel } from '@/server/queries/marketing'
import {
  addCampaign, addPoints, cancelCampaign, deleteCampaign, deletePoints,
  generateRecipients, markSent,
                    ...
                    {c.status === 'borrador' && (
                      <>
                        <button
                          ...
                          data-tip="Armar lista de destinatarios"
                          disabled={pending}
